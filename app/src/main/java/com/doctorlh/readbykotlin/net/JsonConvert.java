...
import com.doctorlh.readbykotlin.bean.CommonResponse;
import com.doctorlh.readbykotlin.bean.SimpleResponse;
        ...
        if (rawType != CommonResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                if (code == 0) {
                    ...
                    throw new IllegalStateException("commonResponse.msg");
                }
            }
        }
    }
